...
import { benefitCards } from "@/utils/constants";
    ...
    return (
        <section className="px-4 md:px-6">
            <div className="w-full max-w-325 mx-auto rounded-3xl md:rounded-[36px] py-10 md:py-19 md:px-6 relative overflow-hidden">
                {/* Decorations */}
                <Image src="/images/pot.svg" alt="pot-icon" height={140} width={76} className="hidden md:block absolute top-25 left-8 deco-float-1" />
                <Image src="/images/cup.svg" alt="cut-icon" height={98} width={56} className="hidden md:block absolute top-100 right-8 deco-float-5" />
                ...
                <div className="max-w-220 mx-auto relative">
                    ...
                    >
                        ...
                        <H3 className="text-center text-grad mt-2 md:mt-4 w-full md:w-142.25 mx-auto">A Better Way To Discover. Decide. Buy.</H3>
                    </motion.div>
                    {/* Benefits Grid */}
                    <div className="mt-6 md:mt-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
...
function BenefitCard({ item, index,}: {
    ...
    return (
        ...
        >
            <Image src={item.image} alt={`benefits-${index}`} height={260} width={250} />
